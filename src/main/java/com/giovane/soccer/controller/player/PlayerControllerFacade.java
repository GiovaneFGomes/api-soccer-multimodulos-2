...
import static com.giovane.soccer.controller.mapper.request.PlayerControllerRequestMapper.toPlayerServiceWithId;
import static com.giovane.soccer.controller.mapper.request.PlayerControllerRequestMapper.toPlayerServiceWithoutId;
...
public class PlayerControllerFacade {
    ...
    public Mono<PlayerControllerResponse> save(PlayerControllerRequest playerControllerRequest) {
        return facade.save(toPlayerServiceWithoutId(playerControllerRequest))
    ...
    public Mono<PlayerControllerResponse> update(PlayerControllerRequest playerControllerRequest, String id) {
        return facade.update(toPlayerServiceWithId(playerControllerRequest, id))
                .map(PlayerControllerResponseMapper::toPlayerControllerResponse);
    }
